		...
		<div id="wrap" class="fixed">
			<div id="content">
				...
				<?php echo $this->Form->create('QuemSomo'); ?>
					<fieldset>
						<h1><?php echo __('Edição Quem Somos'); ?></h1>
					<?php
				...
				<div class="actions admin-pages">
					...
					<ul>
						...
						<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('QuemSomo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('QuemSomo.id'))); ?></li>
